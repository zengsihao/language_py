                        ...
                        for key_old, key_xml in oldDic.items():
                            ...
                            if "." in key_old:
                                ...
                                if isSwift == True:
                                    ...
                                    x_key_old_other = f'"{key_old}"' + '.localized('
                                    s_key_xml_other = f'"{key_xml}"' + '.localized('
                                ...
                                #  "verify_private_key".localized()
                                if x_key_old_other in line:
                                    line = line.replace(x_key_old_other, s_key_xml_other)
                            else:
                                if isSwift == True:
                                    x_key_old_other = f'"{key_old}"' + '.localized('
                                    s_key_xml_other = f'"{key_xml}"' + '.localized('
...
def main():
    ...
    file_utils = '/Users/ahao/Documents/INTO/NewCode/IosInto/alpha-wallet-ios/utils/'

    replaceSiwftRswift(file, replaced_output_path)
    replaceSiwftRswift(file_utils, replaced_output_path)
